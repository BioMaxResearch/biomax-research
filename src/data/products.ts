...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Semaglutide',
    slug: 'semaglutide',
    description: 'Semaglutide is a GLP-1 receptor agonist used in research to study glucose metabolism, appetite regulation, and metabolic pathways. It is structurally similar to human GLP-1 with modifications that extend its activity.',
    shortDescription: 'GLP-1 receptor agonist for metabolic research',
    category: 'Obesity Research',
    variants: [
      { id: '5-3mg', name: '3mg', sku: 'BM-SEMA-3', price: 89.00, inStock: true },
      { id: '5-5mg', name: '5mg', sku: 'BM-SEMA-5', price: 129.00, inStock: true },
      { id: '5-10mg', name: '10mg', sku: 'BM-SEMA-10', price: 229.00, inStock: true },
    ],
    image: '/placeholder.svg',
    images: ['/placeholder.svg'],
    featured: true,
  ...
  },
  {
    ...
    name: 'PT-141',
    slug: 'pt-141',
    description: 'PT-141 (Bremelanotide) is a synthetic peptide that acts on melanocortin receptors. Research has explored its effects on central nervous system pathways in preclinical models.',
    shortDescription: 'Melanocortin receptor agonist',
    category: 'Sexual Research',
    variants: [
      { id: '11-10mg', name: '10mg', sku: 'BM-PT141-10', price: 35.00, inStock: true },
    ],
    image: '/placeholder.svg',
    images: ['/placeholder.svg'],
    featured: false,
    ...
    researchApplications: [
      ...
      'Behavioral response investigations',
    ],
    productDetails: {
